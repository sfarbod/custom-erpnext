...
# hrms
RUN bench get-app --branch v16.8.0 --skip-assets https://github.com/frappe/hrms
RUN bench get-app --branch v1.5.0 https://github.com/sfarbod/ERPNext_Extensions
...
RUN bench get-app --branch v1.25.1 --skip-assets https://github.com/frappe/helpdesk
RUN bench get-app --branch v2.54.2 --skip-assets https://github.com/frappe/lms
RUN bench get-app --branch v3.9.11  https://github.com/frappe/insights
